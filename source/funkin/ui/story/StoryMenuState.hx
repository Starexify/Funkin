...
class StoryMenuState extends MusicBeatState
{
  ...
  override function create():Void
  {
    ...
    tracklistText.setFormat(Paths.font("VCR OSD Neue.ttf"), 32);
    ...
    scoreText.setFormat(Paths.font("VCR OSD Neue.ttf"), 32);
    ...
    levelTitleText.setFormat(Paths.font("VCR OSD Neue.ttf"), 32, FlxColor.WHITE, RIGHT);
