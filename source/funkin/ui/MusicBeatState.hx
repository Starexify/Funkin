...
class MusicBeatState extends FlxTransitionableState implements IEventHandler
{
  ...
  function createWatermarkText()
  {
    ...
    leftWatermarkText.setFormat(Paths.font("VCR OSD Neue.ttf"), 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
    rightWatermarkText.setFormat(Paths.font("VCR OSD Neue.ttf"), 16, FlxColor.WHITE, RIGHT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
