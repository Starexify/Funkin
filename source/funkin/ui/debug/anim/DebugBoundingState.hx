...
class DebugBoundingState extends FlxState
{
  ...
  function initOffsetView():Void
  {
    ...
    txtOffsetShit.setFormat(Paths.font("VCR OSD Neue.ttf"), 26, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
  ...
  function addInfo(str:String, value:Dynamic)
  {
    ...
    swagText.setFormat(Paths.font("VCR OSD Neue.ttf"), 26, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
